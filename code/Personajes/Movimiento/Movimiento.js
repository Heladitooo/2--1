...
function mover() {
  ...
  if (
    movXp1 <= canvas.width - 20 &&
    movYp1 <= canvas.height - 20 &&
    movXp1 >= 0 + 10 &&
    movYp1 >= 0 + 10
  ) {
    if (teclasEstado[87]) {
    ...
    if (movXp1 >= canvas.width - 20) {
      movXp1 -= velocidad;
    }
    if (movYp1 >= canvas.height - 20) {
      movYp1 -= velocidad;
    }
    if (movXp1 <= 0 + 10) {
      movXp1 += velocidad;
  ...
  if (
    movXp2 <= canvas.width - 20 &&
    movYp2 <= canvas.height - 20 &&
    movXp2 >= 0 + 10 &&
    movYp2 >= 0 + 10
  ) {
    if (teclasEstado[38]) {
    ...
    if (movXp2 >= canvas.width - 20) {
      movXp2 -= velocidad;
    }
    if (movYp2 >= canvas.height - 20) {
      movYp2 -= velocidad;
    }
    if (movXp2 <= 0 + 10) {
      movXp2 += velocidad;
